...
Naiasno is built from open Bulgarian datasets, pre-processed into static files and served as a single-page app. Alongside election results it now carries several public-money and public-record features:
