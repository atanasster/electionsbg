...
For us it has a direct consequence too: that annex is exactly what fills the [breakdown of capital spending by project and region](/budget). No annex for 2026 means no breakdown for that year.
...
[^doo]: State Social Security Budget Act for 2026, promulgated in the State Gazette No. 68 of 28.07.2026; the minimum insurable thresholds by economic activity are in Annex 1 (through 31 July) and Annex 1A (from 1 August) — parsed in [our MOD reference](/budget/mod). Unlike the State Budget Law, this one is already promulgated; it passed 131 in favour to 70 against — a different majority from the state budget. First reported: "Parliament passed the state social-security budget", business.dir.bg, July 2026 — https://business.dir.bg/banki-i-finansi/ns-prie-byudzheta-na-doo-po-visoki-osigurovki-ot-avgust-i-novi-pravila-za-darzhavnite-sluzhiteli
