...
[^petkov]: Kiril Petkov (then co-leader of ПП–ДБ) — that around 20bn would "remain as reserves" managed by the BNB and the state could use them, e.g. to repay its external debt. Quote and context: [Mediapool, 17 May 2025](https://www.mediapool.bg/rezervat-na-bnb-ot-80-mlrd-lv-nyama-da-mozhe-da-se-harchi-sled-vlizaneto-v-evrozonata-news371301.html).
