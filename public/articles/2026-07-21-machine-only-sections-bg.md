...
Тази посока се потвърждава и от отделен анализ върху реални данни: на едни от последните избори машинно са гласували 80% от избирателите на ИТН, 79% на ПП-ДБ и 70% на Възраждане, докато тези на ГЕРБ, ДПС и БСП са предпочели хартия ([Свободна Европа](https://www.svobodnaevropa.bg/a/32352096.html)).
...
- Това, което измерваме, е **ефектът от състава (селекцията)** — промяната, която идва единствено от това кой с какво е гласувал. Това не е пълният ефект от задължаването на машините, който би променил и активността, би „спасил“ развалени бюлетини и би добавил собственото влияние на машината върху вота.
