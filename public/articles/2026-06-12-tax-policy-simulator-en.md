...
**Excise duties.** This is the biggest tax line the simulator long left untouched — over **€3.8B** in 2025, more than corporate tax. So we added four levers: fuel, tobacco and alcohol move as a **percentage change to the existing rate** (each category carries dozens of sub-rates — petrol, diesel, LPG, the specific-plus-ad-valorem on cigarettes — so a single "euro-per-litre" slider would be meaningless), while wine is a **new excise on today's zero rate**. The bases come straight from the Customs Agency annual chronicle: fuel ≈ €1.44B, tobacco ≈ €2.15B, alcohol ≈ €177M in 2025.[^excise] Two facts set the room to move: petrol (€363/1000L) and diesel (€330/1000L) already sit ~at the EU minimum, so there is no legal room to cut; tobacco is above the EU floor (€90/1000 cigarettes and ≥60% of the weighted-average retail price), with a legislated climb to about €132 by 2029. The behavioral correction matters most for tobacco: a steep hike pushes the market to illicit and cross-border trade — as in 2009–2010, when the illicit share jumped from 17.5% to nearly 40% — so a big increase can even shrink revenue. Wine, conversely, Bulgaria taxes at €0 (the EU minimum is also €0) — introducing one is a legal choice; for reference France levies a token €4/hl, the Netherlands about €48/hl.
...
| Fuel excise — base leakage, %/pp              | 0.10 (0.04–0.25) | demand −0.1…−0.3 + cross-border trade[^excise]       |
| Tobacco excise — base leakage, %/pp           | 0.25 (0.12–0.60) | EU panel ≈ −0.4 + illicit market 2009–10[^excise]    |
| Alcohol excise — base leakage, %/pp           | 0.25 (0.12–0.50) | spirits −0.5…−0.8 + home production[^excise]         |
