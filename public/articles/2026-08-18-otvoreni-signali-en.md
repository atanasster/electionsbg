...
![The "fired flags" block on a contract page: the letter grade, the "4 of 10 applicable checks" counter, and the full ledger — the four checks that fired, the six that passed, and the three that cannot be evaluated at all, each with its explanation and legal basis.](/articles/images/procurement-risk/02-signals.webp)
