---
keywords:
  - Bulgaria budget 2026
  - 2026 state budget Bulgaria
  - 5.7% deficit
  - excessive deficit procedure
  - ZDBRB 2026
  - budget simulator
  - Galab Donev budget
  - Progressive Bulgaria budget
  - maximum insurable income 2300
  - Bulgaria government debt
  - Videnov-era deficit
  - budget reforms 2026
...
This article lines up the **verified numbers** from the official documents, gathers **what the politicians and economists actually say** (with a source for every claim), and then **runs those claims through our [budget simulator](/budget/simulator)** to see which survive the arithmetic and which are mostly rhetoric — and finally cost out what it would take to reach 3% as early as this year.
...
- The maximum insurable income (МОД) rises from **€2,112 to €2,300** from 1 August — effect **+€90.8M**.
- Minimum insurance thresholds above the minimum wage — **+€50.9M**.
- Toll system and vignettes (+30%) from 1 August — **+€53.3M**.
- Improved collection of social-security (ДОО) revenue — **+€100M**; Sofia Airport concession — **+€50M**; additional collection measures — **+€200M**; gambling — **+€100M**; Modernisation Fund — **+€100M**.
- An accelerated tobacco excise calendar (new rates from 1 August too); a licensing regime and a two-component fee for gambling affiliate operators.

**Expenditure measures**

- A one-off 5% indexation of budget-sector salaries (instead of the automatic mechanism, which would have cost an extra €564.7M).
- A **10% cut to wage-and-contribution spending** from 1 September (−€85M in 2026, −€170.7M in 2027) — with exemptions for municipalities, the "security" agencies under Art. 69 of the Social Insurance Code, delegated budgets and hospitals.
- Removal of the COVID supplement for newly granted pensions after 1 July 2026 (−€2.9M); a **freeze of the maximum pension** at its 2022 level (€1,738.40).
- A party-subsidy **cut from €4.09 to €3.00 per vote** (−€2.1M); the religious-denomination subsidy from €10.2 to ≥€7.7 per vote (−€5M).
- Optimisation of central-budget spending (−€545.5M) and of subsidies to the railways (BDZ, NKZHI) and Bulgarian Posts (−€285.3M); tighter control of social payments (−€200M).
- The **minimum wage is frozen** at its 2026 level until a new mechanism under Art. 244 of the Labour Code is worked out in 2027.
- A phased introduction of **personal social-security contributions** for civil servants and the judiciary (80:20 from 1 August 2026), with compensation so that net income is preserved.
...
## Checking with the budget simulator
...
**The opposition.** GERB-SDS, through [Toma Bikov](/candidate/mp-5236), made the historical reference: if the budget passes in this form, "Bulgaria's progress will resemble the mid-1990s, when the BSP and Zhan Videnov governed with a full majority," and called the framework "a sign of a total absence of reform" — recalling that Radev himself, as president, had demanded the resignation of the "Zhelyazkov" cabinet over a budget with a 3% deficit.[^bikov] **PP-DB demanded the budget be withdrawn and reworked down to 3%.**[^db-ottegli] [Asen Vasilev](/candidate/mp-5184) (PP) called it "more scandalous" than the budget that toppled the "Zhelyazkov" cabinet;[^db-statement] DB spoke of "the same old budget" with no reforms[^db-statement] and "a whiff of the Videnov era," and [Martin Dimitrov](/candidate/mp-5245) said "a deficit of 5.7% hasn't been seen since Zhan Videnov."[^fakti-obzor] [Kostadin Kostadinov](/candidate/mp-5258) (Vazrazhdane) was categorical: "a complete catastrophe."[^kostadinov]
...
## How do you reach 3% as early as 2026? Scenarios with the simulator
...
Below, each lever is costed with the [simulator](/budget/simulator) — on an annual basis and **with the behavioural response included** (which is why the amounts are smaller than the "textbook" ones; raise a rate and the base shrinks). A mid-year start further dampens the effect for 2026 — another argument for why the government spreads the consolidation out.
...
- **A · Purely on revenue.** VAT to 23% (+€1,188), income tax to 13% (+€1,099), corporate to 12% (+€602), dividend 5→10% (+€45), plus ~€500M of real collection = **≈ €3.43bn**. The price: every Bulgarian pays more VAT and income tax, and the emblematic 10% flat tax disappears.
...
Every number here can be checked: open the [Budget dashboard](/budget) for the live cash execution and the [simulator](/budget/simulator) to run your own scenarios against the same official figures.

---

_Methodology and sources. The framework figures are from the draft ЗДБРБ-2026 and АСБП 2026–2028 tabled in the National Assembly (Ministry of Finance, 24 June 2026). The "check" figures are from an actual run of the [budget simulator](/budget/simulator) engine (`src/lib/bgTaxPolicy.ts`, `src/lib/bgFiscalProjection.ts`), whose baseline rests on the 2025 cash execution and the EC's spring forecast. Quotes from politicians and economists are from media published between 24 and 25 June 2026, named individually below._
...
[^cik]: Results of the election for the 52nd National Assembly, 19 April 2026 — Central Election Commission; summarised in [the 19.04.2026 results on electionsbg](/?elections=2026_04_19) (Progressive Bulgaria 1,444,920 votes / 44.59% / 131 seats; turnout 51.11%).
