...
updatedAt: ⟦TBD: дата на последна редакция⟧
---

# Бюджет 2026: приет на седмия месец — какво показват числата

На 24 юли 2026 г., след седем месеца работа по „удължителен закон“, Народното събрание прие на второ четене Закона за държавния бюджет за 2026 г. — със **125 гласа „за“ и 84 „против“**.⟦TBD: потвърждение от нашите данни за поименното гласуване след ингест⟧[^bta] Рамката остана такава, каквато беше внесена през юни: **дефицит по консолидираната фискална програма от 5,7% от БВП**, нов дълг до **10,1 млрд. €** и минимална заплата, замразена на **620,20 €**.

Спорът след гласуването тръгна веднага в две посоки. Опозицията говори за рекорден дефицит и за текстове, извадени от закона. Управляващите — за наследени разходи. Тази статия не подрежда цитатите един срещу друг, а ги проверява с данните, които поддържаме сами: **касовото изпълнение на бюджета месец по месец от 2021 г. насам, текстовете на всички бюджетни закони от 2018 г. и поименните гласувания на всеки депутат от 44-то Народно събрание досега.** Там, където числата още не са окончателни, това е отбелязано изрично.
...
⟦TBD: цялата таблица да се провери срещу обнародвания текст в ДВ; към момента числата са от внесения проект и АСБП 2026–2028⟧
...
| ------------------------------- | ------------------- | ------------- | ------- |
| Приходи, помощи и дарения       | 28 207,1 млн. €     | ⟦TBD: 28 460⟧ | +0,9%   |
| Разходи                         | 15 749,8 млн. €     | ⟦TBD: 17 600⟧ | +11,7%  |
| Бюджетни взаимоотношения (нето) | 15 071,1 млн. €     | ⟦TBD: 16 890⟧ | +12,1%  |
| — за общините                   | 4 563,7 млн. €      | ⟦TBD: 4 928⟧  | +8,0%   |
| — за ДОО                        | 6 224,2 млн. €      | ⟦TBD: 6 745⟧  | +8,4%   |
| — за НЗОК                       | 1 892,2 млн. €      | ⟦TBD: 2 052⟧  | +8,5%   |
| Вноска в бюджета на ЕС          | 1 033,1 млн. €      | ⟦TBD: 1 280⟧  | +23,9%  |
| **Салдо**                       | **−3 646,9 млн. €** | ⟦TBD: −7 310⟧ | **×2**  |
...
Ключът към спора е **вторият вариант**. След протестите от ноември бюджетът беше оттеглен и преправен: Фискалният съвет описва преработката като свиване на приходите и разходите **с по 1 млрд. € поравно**, при което абсолютният дефицит остава непроменен на **3,65 млрд. €**.[^fiscal-preraboten]

| Рамка по КФП | ноември (v1) | декември (v2) | приет        | Δ v2 → приет      |
| ------------ | ------------ | ------------- | ------------ | ----------------- |
| Приходи      | 51,4 млрд. € | 50,4 млрд. €  | 49,6 млрд. € | **−0,8 млрд. €**  |
| Разходи      | 55,0 млрд. € | 54,0 млрд. €  | 56,8 млрд. € | **+2,8 млрд. €**  |
| Дефицит      | 3,65 млрд. € | 3,65 млрд. €  | 7,19 млрд. € | **+3,54 млрд. €** |

И тук числата на Петкова се връзват точно. Тя определи разликата като **„778 млн. € по-малко приходи“ и „2,8 млрд. € повече разходи“**[^faktor-gerb] — което е именно съпоставката спрямо декемврийския вариант, не спрямо ноемврийския. Сборът затваря: −0,8 + 2,8 = 3,6 млрд. € разлика в дефицита. **Аритметиката ѝ е вярна.**

⟦TBD: двата източника дават леко различна база — Фискалният съвет работи с 50,402 / 54,052 млрд. € за v1 и 49,402 / 53,052 за v2, а economic.bg с 51,4 / 55,0 за v1. Разликата от около 1 млрд. € е въпрос на обхват и трябва да се уеднакви след ингеста; посоките и разликите съвпадат и при двете бази.⟧
...
Най-вероятният изход е, че **5,7% е таван, а не прогноза** — и че истинският резултат ще се определи от това колко от капиталовата програма физически може да се разплати до 31 декември. ⟦TBD: преизчисление след юнския отчет по КФП, който излиза в началото на август и дава шестмесечна база⟧
...
Субсидията се удвоява между 2022 и 2025 г., като само през 2025 г. скача с 60%. Дали намалението връща линията към нивата от 2024 г., или под тези от 2022 г., зависи изцяло от това коя от двете мерки е записана в закона. ⟦TBD: да се разчете таблицата на субсидията от обнародвания текст и да се даде точният процент⟧
...
За нас това има и пряка последица: тъкмо от това приложение се пълни [разбивката на капиталовите разходи по проекти и области](/budget). Ако за 2026 г. няма приложение, за тази година няма и разбивка. ⟦TBD: решение как да се показва липсващата година⟧
...
При този бюджет посоката е обратната на обичайната. На първо четене на 15 юли „за“ гласуват 145 депутати — **128 от Прогресивна България и 17 от ДПС**. Девет дни по-късно ДПС вече е в колоната „против“. ⟦TBD: да се потвърди с нашите данни за 24.07 след ингест на поименните гласувания⟧
...
⟦TBD: този раздел се пише след ингеста на закона. Планирани проверки:
· МОД 2 300 € — годишен ефект спрямо касов ефект за 2026 г.
· съкращението на разходите за заплати: 85 млн. € по правителствената оценка спрямо нашия двигател
· траектория на дълга 2026–2028 г. спрямо тавана от 37,7 млрд. €
· цената на връщането към 3% при пет месеца остатък от годината⟧
...
[^faktor-gerb]: Изявление на Теменужка Петкова (ГЕРБ) след приемането на бюджета, Фактор, 23–24.07.2026 — ⟦TBD: точен URL⟧

[^faktor-pp]: Изявление на Асен Василев (ПП) след приемането на бюджета, Фактор, 23.07.2026 — ⟦TBD: точен URL⟧
...
⟦TBD: източници за данните ни — касовото изпълнение по КФП (data.egov.bg), текстовете на бюджетните закони (Държавен вестник) и поименните гласувания (parliament.bg) — да се добавят с бележка за метода, както в предишната статия⟧
