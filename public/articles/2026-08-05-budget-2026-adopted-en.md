---
keywords:
  - Bulgaria budget 2026 adopted
  - state budget law 2026
  - 5.7% deficit
  - excessive deficit procedure
  - new state debt 10.1 billion
  - minimum wage 620 euro
  - municipal investment programme
  - Annex 3 budget
  - Fiscal Council opinion
  - budget execution 2026
  - roll-call vote budget
  - budget simulator
schemaType: NewsArticle
updatedAt: ⟦TBD: last edit date⟧
---
...
⟦TBD: verify the whole table against the promulgated text in the State Gazette; figures currently come from the submitted draft and the 2026–2028 medium-term forecast⟧
...
| ----------------------------- | -------------- | ------------- | ------ |
| Revenue, grants and donations | €28,207.1M     | ⟦TBD: 28,460⟧ | +0.9%  |
| Expenditure                   | €15,749.8M     | ⟦TBD: 17,600⟧ | +11.7% |
| Net transfers                 | €15,071.1M     | ⟦TBD: 16,890⟧ | +12.1% |
| — to municipalities           | €4,563.7M      | ⟦TBD: 4,928⟧  | +8.0%  |
| — to the state pension fund   | €6,224.2M      | ⟦TBD: 6,745⟧  | +8.4%  |
| — to the health fund          | €1,892.2M      | ⟦TBD: 2,052⟧  | +8.5%  |
| Contribution to the EU budget | €1,033.1M      | ⟦TBD: 1,280⟧  | +23.9% |
| **Balance**                   | **−€3,646.9M** | ⟦TBD: −7,310⟧ | **×2** |
...
## The deficit: how much of it is actually a choice
...
## But 5.7% is a ceiling the calendar makes hard to reach
...
The most likely outcome is that **5.7% is a ceiling rather than a forecast** — and that the real result will be set by how much of the capital programme can physically be paid out by 31 December. ⟦TBD: recompute after the June cash-execution release in early August, which gives a six-month base⟧

## Who actually overestimated collection
...
**The National Children's Hospital.** [Asen Vasilev](/candidate/mp-5184) said the children's-hospital provisions "were in every budget since 2022" and are missing for the first time.[^faktor-pp] The archive shows otherwise:

- **2022** — no such provision.
- **2023** — the only mention is a hospital for children's diseases, "St. Anastasia", in **Burgas**, a different facility.
- **2024** — Art. 109: the Council of Ministers arranges the tendering of the **design**. No money.
- **2025** — Art. 114: the health minister creates the conditions for construction **"at the company's own expense"**. Again no money.
...
The subsidy doubles between 2022 and 2025, jumping 60% in 2025 alone. Whether the cut returns the line to 2024 levels or below 2022 levels depends entirely on which of the two measures is actually written into the law. ⟦TBD: parse the subsidy table from the promulgated text and give the exact percentage⟧
...
For us it has a direct consequence too: that annex is exactly what fills the [breakdown of capital spending by project and region](/budget). No annex for 2026 means no breakdown for that year. ⟦TBD: decision on how to present the missing year⟧
...
⟦TBD: this section is written after the law is ingested. Planned checks:
· the €2,300 maximum insurable income — annual effect versus 2026 cash effect
· the wage-bill cut: €85M on the government's estimate versus our engine
· the debt trajectory 2026–2028 against the €37.7bn ceiling
· what returning to 3% would cost with five months left in the year⟧
...
[^faktor-gerb]: Statement by Temenuzhka Petkova (GERB) after the budget was passed, Faktor, 23–24.07.2026 — ⟦TBD: exact URL⟧
...
⟦TBD: source notes for our own data — cash execution (data.egov.bg), budget law texts (State Gazette) and roll-call votes (parliament.bg) — to be added with a method note, as in the previous article⟧
