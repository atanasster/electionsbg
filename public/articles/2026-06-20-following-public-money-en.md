...
**Where this module fits:** it borrows the international playbook — the explainable Fazekas-style risk index, the DOZORRO "follow an entity" idea, OCDS-grade structure — and adds the one thing none of the others localise: the **political-accountability cross-join**. Every contract is checked against the Bulgarian political class — MPs, ministers, agency heads, governors, mayors, deputy-mayors and councillors — via their declarations to the [Audit Office](https://register.cacbg.bg/) and the [Commerce Registry](https://portal.registryagency.bg/CR/). The table below compares feature by feature.
...
**Single-supplier concentration.** Across the corpus, **51% of contracts whose bid count is published had a single bidder** — Bulgaria's well-documented competition problem. The feed surfaces the extreme cases: buyers that have sent *100%* of their procurement to one company. Many are small schools — e.g. a secondary school in the village of Ribnovo that placed all **€5.0 million** of its contracts with a single Blagoevgrad firm — where a single supplier dominating millions in spending warrants closer scrutiny, even if each award was lawful.

**The political class as contractors.** The module records **38 MPs tied to 41 companies** that have won contracts worth **€533 million** over the full period, and **72 non-MP officials** tied to **70** contractor companies. The largest ties run through state-owned enterprises: an MP registered as a director of the state road-builder [Avtomagistrali](/company/831646048) — **€325 million** in contracts; another MP at [Bulgarian Posts](/company/121396123) at **€101 million**; a state-agency head registered at the IT company [Informatsionno Obsluzhvane](/company/831641791) at **€150 million**. Alongside them are municipal councillors with a directly declared stake — e.g. in [Global Cleaner](/company/202758921) (cleaning, €30 million) and [Etropal Trade](/company/122055819) (medical supplies, €18 million). None of this is itself wrongdoing — it is exactly the map of declared interest that was, until now, scattered across thousands of filings.

**Per-município reality.** Because every local buyer is pinned to its settlement, you can read a município like [Plovdiv](/procurement/settlement/56784) directly: **€3.5 billion** awarded across 12,404 contracts, led by the regional electricity distributor, the university hospital and the municipality itself.
