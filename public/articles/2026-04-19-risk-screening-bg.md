...
> **Обновление (21.05.2026 г.):** Географските рискови клъстери вече са **петият контекстуален сигнал** на композитния индекс (39/100) — виж раздел 3. Както останалите контекстуални сигнали, той се показва до главната оценка, но никога не влиза в нея.
...
- **Секционен скрининг (39/100):** Измерва претегления дял (1.95%) от общата активност, генериран в секции с висок рисков профил.
...
|---|---|---|
| **Критична (≥80)** | 10 | 0.08% |
| **Висока (60–80)** | 210 | 1.65% |
| **Повишена (30–60)** | 1 744 | 13.73% |
| **Ниска (<30)** | 10 741 | 84.54% |
