...
- **Регистрирани връзки**: управленски роли, съдружия и записи за действителен собственик, изтеглени от [Търговския регистър](https://portal.registryagency.bg/CR/en/Verifications/Verifications) за същите тези фирми, плюс други фирми, в които същите лица фигурират.
...
Под блока с ключовите числа стои филтрираща лента с чипове (Linear/Notion-style). Цялото състояние живее в URL-а, така че журналист може да копира `naiasno.bg/connections?ns=52&crossParty=1` директно в туит, и същият набор от чипове управлява и картата за най-силни връзки отдолу, и орбиталния граф, така че смяната на чип пренарежда и двата изгледа едновременно:
...
Връзката „Всички фирми" в плочката на таблото отваря [търсима таблица](/governance/companies). Тя вече не е само за депутати: обхваща всички лица на публична длъжност — министри, кметове, общински съветници, магистрати и членове на регулаторни органи — и заедно с тях **17 608** организации, от които депутатските са малка част. Освен фирми в списъка има сдружения, читалища и фондации, затова видът на организацията е изписан, когато не е фирма.

Всеки ред казва на какво се крепи: **17 094** организации са свързани чрез вписване в Търговския регистър, **1335** — чрез деклариран дял пред Сметната палата, а при **2342** всички вписвания в регистъра са **заличени** и ролята е отбелязана като бивша (**2106** от тях нямат и деклариран дял). Свързването е по идентичност, а не по съвпадение на име — име, което регистърът приписва на повече от един човек, се отхвърля, а не се степенува.
...
Примерът горе е **„ПиВи Квантум" ООД** — така я наричат декларациите, с посочено седалище Велико Търново. Търговският регистър днес вписва същото ЕИК, [206258486](/company/206258486), като „Инолед България" ЕООД със седалище с. Лозен — фирма достатъчно малка, че двама депутати (Венеция Огнянова Нецова-Ангова в 48-то и 49-то НС, и Николай Георгиев Ангов в 47-то НС) всеки да са декларирали дял от 33–100% срещу нея за две отчетни години, включително прехвърлен дял през 2022.
