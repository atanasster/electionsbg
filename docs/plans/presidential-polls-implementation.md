...
| --- | --- | --- | --- | --- |
| 1 | Foundations | Question model, publication metadata and acceptance validation | In progress | |
| 2 | Foundations | Reviewed candidate aliases and unresolved coverage | Pending | |
...
- `docs/plans/presidential-polls-audit-v1.md` (audit from preceding turn)
