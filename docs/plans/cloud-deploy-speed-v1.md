...
skipping prod. v2-c (the derived-object registry) and v2-d (the resolver that reads
it, a pure function) are done; v2-e (wiring the resolver into the orchestrator's
emission + per-loader suppression for the double-refresh) is the remaining
