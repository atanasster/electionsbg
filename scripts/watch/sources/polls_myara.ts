// Polls — Мяра (myara.bg). Thin wiring only: the monotonic-fingerprint logic
// (high-water mark, first-run backlog) lives once in
...
import { myara } from "../../polls/agencies/myara";

export const pollsMyara = makeAgencyPollsWatcher({
  id: "polls_myara",
  label: "Polls — Мяра",
  url: "https://myara.bg",
  lister: myara,
