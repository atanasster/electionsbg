...
test.skipIf(skipDb)(
  "the two folds agree over the alphabet the rules can see",
  async () => {
...
test.skipIf(skipDb)(
  "the two folds agree on MIXED CASE — the lower() asymmetry",
  async () => {
...
test.skipIf(skipDb)(
  "the two folds agree on the words readers actually type",
  async () => {
    await parity(
      [
        "",
...
test.skipIf(skipDb)(
  "the two folds agree on real names from the corpus the routes serve",
  async () => {
...
test.skipIf(skipDb)(
  "the fold is the IDENTITY on a needle no rule can rewrite",
  async () => {
...
test.skipIf(skipDb)(
  "the alternate needle actually recovers what the plain one cannot",
  async () => {
