...
test.skipIf(skipDb)(
  "the P tier's flag matches person_browse_table exactly",
  async () => {
...
test.skipIf(skipDb)(
  "the private tiers are FALSE, never null — they are not in the register at all",
  async () => {
...
test.skipIf(skipDb)(
  "the partial index exists — the hub's declared group is a ranked scan",
  async () => {
