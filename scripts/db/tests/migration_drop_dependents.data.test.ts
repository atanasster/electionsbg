...
const SANCTIONED: Record<string, { dependents: string[]; why: string }> = {
  person_wealth_year: {
    ...
    why:
      "090's DROP … CASCADE takes all four, and load_declarations_pg.ts — the only applier " +
      "of 090 — applies 097/100/105/120 AFTER it on the same path. Each of those four " +
