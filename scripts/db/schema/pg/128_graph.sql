...
-- `officer_count` = distinct linked persons — the association-noise signal (cf. 084's
-- public_officer_count / MAX_CO_OFFICERS=6): a company with dozens of "officers" is a mass-
-- membership org, not a real business tie, and the serving layer suppresses edges through it.
