...
/**
 * Parse a "Числови данни от протокол" HTML page into the two turnout fields.
 * Returns null when neither field is present (wrong page / empty protocol).
 */
export const parseChisloviHtml = (html: string): ChisloviData | null => {
  ...
  if (numRegisteredVoters == null && totalActualVoters == null) return null;
  return {
