...
// (mi/chmi elected office holders) + sanctions (OFAC/EU, curated) + regulators (curated
// rosters of the independent bodies — Конституционен съд / Сметна палата / КФН / БНБ / СЕМ
// / КЗК / Омбудсман). The mp id is the
