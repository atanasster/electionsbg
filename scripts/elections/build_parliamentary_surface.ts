...
import { ballotMapMeta } from "../../src/screens/elections/electionSurfaceDescriptors";
import {
  factsFor,
  rankedFrom,
} from "../../src/data/elections/parliamentarySurface";
...
// ⚠ RE-EXPORTED, NOT RE-DECLARED — the browser cannot import this file, and the canonical
// adapter needs exactly these two rules. `parliamentarySurface.ts` records what the private
// copy was missing.
export {
  factsFor,
  rankedFrom,
