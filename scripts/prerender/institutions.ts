...
// The МО roster count is DERIVED, never typed as a literal: these four strings
// are the prerendered <title>/<meta description>/body of /awarder/000695324, so
// a stale number here is a wrong count in an INDEXED page — the most visible
// copy of all, and the one a de-hardcoding sweep is likeliest to miss.
...
<p>The €51M of textbooks is procured by 606 schools, not centrally, via direct award to the copyright holder (art. 79 ЗОП). The market is a duopoly — Klett Bulgaria (which absorbed Anubis and Bulvest 2000) and the Prosveta group hold about 74%; the concentration index (HHI) is above 2,500 — a highly concentrated market. See also <a href="${SITE}/en/procurement">public procurement</a> and the <a href="${SITE}/en/budget">state budget</a>.</p>`.trim(),
  ...
  },
  {
    ...
    descriptionEn:
      "Public procurement of the ${MO_ENTITIES.length} Ministry of Defence units (МО, EIK 000695324) — over €2bn on aviation sustainment, fuel, equipment and military health, with contractor concentration and the single-bid share. F-16 and Stryker acquisition runs through US FMS and is not in the register. Sourced from the АОП register.",
    bodyBg: `
<h1>Министерство на отбраната — обществени поръчки</h1>
<p>Министерството на отбраната (МО, ЕИК 000695324) и подчинените му структури — Българската армия, Военномедицинската академия, военните академии и военните клубове — възлагат обществени поръчки за поддръжка на техниката, горива, оборудване и медицина. Тази страница консолидира договорите на ${MO_ENTITIES.length}-те структури от регистъра на АОП: над 2 млрд. € договорена стойност, концентрация на изпълнителите (HHI) и дял на договорите с една оферта по структура.</p>
...
<p>The Ministry of Defence (МО, EIK 000695324) and its subordinate units — the Bulgarian Army, the Military Medical Academy, the military academies and the military clubs — procure maintenance, fuel, equipment and medical supplies. This page consolidates the contracts of the ${MO_ENTITIES.length} units from the АОП register: over €2bn of contracted value, contractor concentration (HHI) and the single-bid share by unit.</p>
