...
const PartyDemographicsScreen = lazy(() =>
  import("@/screens/PartyDemographicsScreen").then((m) => ({
    default: m.PartyDemographicsScreen,
  })),
);
...
const ProjectFileScreen = lazy(() =>
  import("./screens/procurement/ProjectFileScreen").then((m) => ({
    default: m.ProjectFileScreen,
  })),
);
const MyProjectFilesScreen = lazy(() =>
  import("./screens/procurement/MyProjectFilesScreen").then((m) => ({
    default: m.MyProjectFilesScreen,
  })),
);
...
const ConsumptionBasketScreen = lazy(() =>
  import("./screens/consumption/ConsumptionBasketScreen").then((m) => ({
...
const ConsumptionEuScreen = lazy(() =>
  import("./screens/consumption/ConsumptionEuScreen").then((m) => ({
    default: m.ConsumptionEuScreen,
  })),
);
const ConsumptionFuelScreen = lazy(() =>
  import("./screens/consumption/ConsumptionFuelScreen").then((m) => ({
...
const ConsumptionElectricityScreen = lazy(() =>
  import("./screens/consumption/ConsumptionElectricityScreen").then((m) => ({
