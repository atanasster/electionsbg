...
> = {
  ...
  school: { icon: School, chipClass: CHIP.sky },
  kindergarten: { icon: ToyBrick, chipClass: CHIP.sky },
  social_care: { icon: HeartHandshake, chipClass: CHIP.sky },
  medical_center: { icon: Stethoscope, chipClass: CHIP.sky },
  cultural_institute: { icon: Theater, chipClass: CHIP.sky },
  agri_academy: { icon: GraduationCap, chipClass: CHIP.sky },
