...
// The href rule itself (Sofia's МИР fold, the unknown-code null) is tested where it lives —
// src/data/local/placeViews.test.ts. What belongs here is only that a row gets one.
