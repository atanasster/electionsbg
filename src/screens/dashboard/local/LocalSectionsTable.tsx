// Full searchable / sortable per-polling-station (section) council results
// table for one local município — the body behind the "see details" link on the
// LocalTopSectionsTile leaderboard. Split out of the município dashboard so the
// dashboard stays at-a-glance (leaderboard only) while the full list lives on
// its own page (LocalSectionsListScreen), mirroring the parliamentary
// TopSectionsTile → SettlementSectionsListScreen split.
//
...
import type { LocalSectionResult, LocalSectionShard } from "@/data/local/types";
...
export const LocalSectionsTable: FC<{
