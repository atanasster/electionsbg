...
// Identical to the national PaperMachineCard, but the input is the party's own
// paper/machine split rather than the regional aggregate. Kept as a separate
// component so the label can read "machine adoption (party voters)" if it ever
// diverges from the national framing.
export const PartyPaperMachineCard: FC<Props> = ({
  paperMachine,
  priorElection,
}) => {
  ...
  return (
    <StatCard
      label={t("dashboard_party_paper_machine")}
      hint={t("dashboard_party_paper_machine_hint")}
    >
