// "Какво купува МК — по функция" — the Ministry of Culture's ЗОП spend folded
// into operating buckets (heritage/construction, IT, printing & media, services,
// energy, other). Each row carries its € share, dominant supplier and single-bid
...
export const KulturaCategoryTile: FC<{
  categories: AwarderCategoryAgg<KulturaCategory>[];
  totalEur: number;
}> = ({ categories, totalEur }) => {
    ...
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-base flex items-center gap-2">
          ...
          {bg
            ? "Какво купува МК — по функция"
            : "What the Ministry of Culture buys — by function"}
        </CardTitle>
      </CardHeader>
