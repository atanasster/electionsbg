// "Какво купува МО — по функция" — the group's ЗОП spend folded into operating
// buckets (maintenance, arms, vehicles, fuel, health, construction, IT, supplies,
// other). Each row carries its € share, dominant supplier and single-bid share.
...
// (red/green) are deliberately avoided here; they're reserved for the single-bid
// signal in the meta line below.
const CATEGORY_COLOR: Record<DefenseCategory, string> = {
  ...
  it_comms: "bg-violet-500",
  supplies: "bg-cyan-600",
  other: "bg-muted-foreground/50",
};

export const DefenseCategoryTile: FC<{
  categories: DefenseCategoryAgg[];
  totalEur: number;
}> = ({ categories, totalEur }) => {
    ...
    <Card id="function">
      <CardHeader className="pb-2">
        <CardTitle className="text-base flex items-center gap-2">
          ...
          {bg ? "Какво купува МО — по функция" : "What МО buys — by function"}
        </CardTitle>
      </CardHeader>
