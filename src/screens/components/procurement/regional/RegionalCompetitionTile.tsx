// „Къде се къса конкуренцията" — per-unit single-bid share across the МРРБ group's ЗОП
// spend: bar length = € contracted, colour green→amber→red by the share of contracts let
// with a single bidder. Pure from the RegionalUnitAgg rollup. Mirrors
// EnvironmentCompetitionTile / TransportCompetitionTile.
//
...
import type { RegionalUnitAgg } from "@/data/procurement/useRegional";
...
export const RegionalCompetitionTile: FC<{ units: RegionalUnitAgg[] }> = ({
  units,
}) => {
