// „Къде се къса конкуренцията" — per-unit single-bid share across the МОСВ group's ЗОП
// spend: bar length = € contracted, colour green→amber→red by the share of contracts let
// with a single bidder. Pure from the EnvUnitAgg rollup. Mirrors TransportCompetitionTile.
//
// FRAMING: single-bid is a RISK SIGNAL, not a verdict — some environment procurement is
// legitimately sole-source (proprietary monitoring instruments, calibration). "Worth a look".
...
import type { EnvUnitAgg } from "@/data/procurement/useEnvironment";
...
export const EnvironmentCompetitionTile: FC<{ units: EnvUnitAgg[] }> = ({
  units,
}) => {
