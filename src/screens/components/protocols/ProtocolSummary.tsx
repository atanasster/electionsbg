                  ...
                  <>
                      ...
                      >
                        ...
                        {!!protocol.numPaperBallotsFound && (
                          <div className="flex justify-between text-xs text-muted-foreground leading-6">
                            ...
                            <div className="flex">
                              <Hint
                                text={t("num_paper_ballots_found_explainer")}
                              >
                                <div className="font-bold text-primary">
                                  {formatThousands(
                                    protocol.numPaperBallotsFound,
                          ...
                          !!protocol.numPaperBallotsFound && (
                            <div className="flex justify-between text-xs text-muted-foreground leading-6">
                              ...
                              <div className="flex">
                                ...
                                <Hint
                                  text={t("pct_supports_noone_paper_ballots")}
                                >
                                  <div className="font-bold text-primary ml-2">
                                    {`(${formatPct(
                                      100 *
                    ...
                    {!isXSmall && !!protocol.numValidMachineVotes && (
                      ...
                      >
                        ...
                        <div className="flex justify-between text-xs text-muted-foreground">
                          <Hint
                            text={t("num_machine_supports_no_one_explainer")}
                          >
                            <div>{`${t("support_no_one")}: `}</div>
                          </Hint>
                          <div className="flex">
                            ...
                            <Hint
                              text={t("pct_supports_noone_machine_ballots")}
                            >
                              <div className="font-bold text-primary ml-2">
                                {`(${formatPct(
                                  100 *
