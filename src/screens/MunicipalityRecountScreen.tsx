...
import { SettlementRecountTable } from "./components/settlements/SettlementRecountTable";

export const MunicipalityRecountScreen: FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 pb-12">
        <SettlementRecountTable municipality={muniCode} title={title} />
      </div>
    </>
  );
};
