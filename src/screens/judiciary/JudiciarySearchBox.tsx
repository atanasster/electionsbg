// The body finder on /judiciary — all 279 courts, prosecution offices and
// investigation services.
//
// This is the page SectorEntitySearch's own header cites as its motivating
// case: it maps 279 bodies and, until /court/:bodyCode landed, had no way to
...
// array) but NOT a typeahead: 279 rows is one small request on arm, after which
