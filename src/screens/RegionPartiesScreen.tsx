...
import { MunicipalityPartyTable } from "./components/municipalities/MunicipalityPartyTable";

export const RegionPartiesScreen: FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 pb-12">
        <MunicipalityPartyTable region={region} title={title} />
      </div>
    </>
  );
};
