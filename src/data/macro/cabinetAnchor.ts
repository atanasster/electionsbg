// Cabinet anchor — types, contexts, helper + hooks. The matching
// CabinetAnchorProvider lives in cabinetAnchorContext.tsx.
//
...
export const CabinetAnchorContext = createContext<CabinetAnchor | null>(null);
export const CabinetAnchorSetterContext = createContext<
