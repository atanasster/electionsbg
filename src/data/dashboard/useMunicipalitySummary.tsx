...
import { useMunicipalityVotes } from "../municipalities/useMunicipalityVotes";
import { useMunicipalityStats } from "../municipalities/useMunicipalityStats";
...
export const useMunicipalitySummary = (
  ...
  const data = useMemo<NationalSummary | undefined>(() => {
    if (!municipalityCode || !selected) return undefined;
    if (!municipality) return undefined;

    const protocol = municipality.results.protocol;
    const currentVotes = municipality.results.votes;
  ...
  return {
    data,
    isLoading: !municipality || (!!municipalityCode && !partyInfos),
  };
};
